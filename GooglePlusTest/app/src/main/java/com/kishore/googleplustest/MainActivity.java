package com.kishore.googleplustest;
...
public class MainActivity extends AppCompatActivity implements
    ...
    private Button mSignOut, mRevokeAccess;
    private LinearLayout mProfileLayout;
    private ImageView mProfilePhoto;
    private TextView mNameView, mEmailView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Views
        mSignIn = (SignInButton) findViewById(R.id.btn_sign_in);
        mSignOut = (Button) findViewById(R.id.btn_signout);
        mRevokeAccess = (Button) findViewById(R.id.btn_revoke);
        mProfileLayout = (LinearLayout) findViewById(R.id.profile);
        mProfilePhoto = (ImageView) findViewById(R.id.profileImg);
