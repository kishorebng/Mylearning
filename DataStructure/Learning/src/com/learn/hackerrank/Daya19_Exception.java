 ...
 * method declaration for it to be accessible by the other classes in the file.
 * 
 * Input Format
 * 
 ...
 * Output Format
 * 
 * You are not responsible for printing anything to stdout. The locked Solution
 * class in the editor below will call your code and print the necessary output.
 * 
 * Sample Input
 * 
 * 6 Sample Output
